        ...
        <div className="container table-size-page">
          <div className="row">
            <div className="col-10 col-md-4 mx-auto text-center">
              <h5 className="table-size-title">
                Men's size charts <i class="fas fa-male"></i>
              </h5>
            </div>
          </div>
            ...
            <div className="col-10 mx-auto mb-4">
              ...
              <ul>
                <li className="footer-text">
                  Neck: Measure around the base of your neck, one to two fingers
                  inserted for comfort.
                </li>
                <li className="footer-text">
                ...
                <li className="footer-text">
                  Waist: Bend to the side to find your natural waist. Measure
                  keeping the tape slightly loose.
                </li>
                <li className="footer-text">
                  Sleeve length: Bend your elbow 90 degrees and place your hand
                  on your hip. Start at the center back of your neck with a
                  friend's help. Measure across your shoulder to your elbow and
                  down to your wrist. Round up to the nearest half inch.
                </li>
                <li className="footer-text">
                  Inseam: Measure a similar garment that fits you well. Lay them
                  flat, with the front and back folded on top of each other.
          ...
          <div className="row">
            <div className="col-10 col-md-4 mx-auto text-center">
              <h5 className="table-size-title">
                Women's size charts <i class="fas fa-female"></i>
              </h5>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-10 mx-auto mb-4">
              ...
              <ul>
                <li className="footer-text">
                  Bust: Measure around the fullest part of your chest, keeping
                  the tape parallel to the floor.
                </li>
                <li className="footer-text">
                  Waist: Bend to the side to find your natural waist. Measure
                ...
                <li className="footer-text">
                  Hips: Measure around fullest part of hips while standing.
                </li>
              </ul>
            </div>
          </div>
