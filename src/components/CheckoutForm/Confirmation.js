        ...
        <div className="container shipping-details">
          <div className="row">
            <div className="col-10 col-md-10 col-lg-6 mx-auto text-center">
              ...
              <h2 className="title-confirmation mb-4">
                Your order has been received.
              </h2>
              <h5>
                Your Transaction number: <span>#{transactionNumber}</span>
              </h5>
              <p className="keep-transaction-number">
                Please keep this transaction number for your records.
              </p>
              <p className="confirmation-text">
                You will receive a confirmation email with you transaction
                number along with information on how to track your order once it
                has been shipped.
              </p>
              <Link to="/">
