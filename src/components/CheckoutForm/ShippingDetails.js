        ...
        <div className="container shipping-details">
          <div className="row">
            ...
            <div className="col-10 col-md-5 col-lg-4 mx-auto my-2 text-left">
              <img src={shipping} alt="img" className="checkout-img" />
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-12 col-md-10 col-lg-8 mx-auto">
              <form>
                ...
                <div className="row">
                  <div className="col-4 col-md-4 col-lg-4 mx-auto m-2">
                    <Link to="/shoppingcart" className="continue-shopping">
                      &#8592; Back
                    </Link>
                  </div>
              ...
              <p className="paymet-text">
                * This form doesn't collect address information. Build for
                example purpose.
              </p>
            </div>
          </div>
