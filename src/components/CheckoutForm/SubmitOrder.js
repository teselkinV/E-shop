                    ...
                    <div className="col-12 col-md-10 col-lg-8 mx-auto">
                      <div className="row">
                        <div className="col-10 col-md-5 col-lg-3 mx-auto">
                          ...
                          <ul className="shipping-info">
                            ...
                            <li className="shipping-info-list-name">
                              {firstName} {lastName}
                            </li>
                            ...
                            <li className="shipping-info-list">
                              {phoneNumber}
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="col-10 col-md-5 col-lg-3 mx-auto">
                          ...
                          <ul className="shipping-info">
                            <li className="shipping-info-list">
                              Sub-total: ${value.itemsTotal}
                            </li>
                            <li className="shipping-info-list">
                              Sales tax: ${value.salesTax}
                            </li>
                            <li className="shipping-info-list">
                              Shipping: $0.00
                            </li>
                            <li className="shipping-info-list summary-total">
                      ...
                      <div className="row">
                        ...
                        <div className="col-10 col-md-4 text-right my-2">
                          <Link
                            to="/"
                            className="continue-shopping continue-checkout"
                          >
                            Continue shopping
                          </Link>
                        </div>
